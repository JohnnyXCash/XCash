...
const string strMessageMagic = "XCash Signed Message:\n";
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sun, 17 Aug 2014 13:31:25 GMT";
        CTransaction txNew;
        txNew.nTime = 1408282287;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
